...
<li class="wo_video-info__item wo_video-info__item--years">{{ date("Y",strtotime($movie['release_date'])) }} </li>
</ul>
</h1>
...
<div class="tabs__tab custom_tab" style="margin-top: -20px;" id="starring">
	<div class="wo_section wo_section--video-details rf_no-margin--bottom">
		...
		<a class="wo_video-thumb track_event" href="">
	...
	<div class="wo_section wo_section--video-details rf_no-margin--bottom">
		...
		@foreach($similarMovies as $similarMovie)
			<?php 
				...
				$movieTitle= str_replace(' ', '-',strtolower($similarMovie['title']));
				$movieTitle = str_replace("'", "", "$movieTitle");
			?>

		<a class="wo_video-thumb track_event" data-event-category="More Like" data-event-label="Twilight" data-event-name="Movies" href="/movies/show/{{ $movieId }}?&keyword={{ $movieTitle }}&matchtype={{ $parameters['matchtype'] }}&creative={{ $parameters['creative']}}&gclid={{ $parameters['gclid'] }} ">
		<div class="wo_video-thumb__poster" data-content="Watch Online" onclick="window.location.href='/movies/show/{{ $movieId }}?&keyword={{ $movieTitle }}&matchtype={{ $parameters['matchtype'] }}&creative={{ $parameters['creative']}}&gclid={{ $parameters['gclid'] }} '"  style="background-image: url({{ $posterImageSimilar  }})"></div>
		<div class="wo_video-thumb__title">
		{{ $similarMovie['title'] }}
		</div>
...
<a class="cta-button track_event_with_conversion watch-now amazon_prime clickout"><div class="label"></div>
<div class="button wo_btn--play" style="font-size: 13px" onclick="redirectAds('{{ $keyword }}', '{{ $matchtype }}', '{{ $creative }}', '{{ $gclid }}')">
Free Trial
</div>
</a><a class="cta-button track_event_with_conversion watch-now hbo   clickout"><div class="label"></div>
<div class="button wo_btn--play" style="font-size: 13px" onclick="redirectAds('{{ $keyword }}', '{{ $matchtype }}', '{{ $creative }}', '{{ $gclid }}')">
...
<a class="wo_video-thumb track_event" data-event-category="More Like" data-event-name="Movies" href="/movies/show/{{ $movieId }}?&keyword={{ $movieTitle }}&matchtype={{ $parameters['matchtype'] }}&creative={{ $parameters['creative']}}&gclid={{ $parameters['gclid'] }}">
<div class="wo_video-thumb__poster" data-content="Watch Online" onclick="window.location.href='/movies/show/{{ $movieId }}?&keyword={{ $movieTitle }}&matchtype={{ $parameters['matchtype'] }}&creative={{ $parameters['creative']}}&gclid={{ $parameters['gclid'] }} '" style="background-image: url({{ $posterImageSimilar  }})"></div>
<div class="wo_video-thumb__title">
{{ $similarMovie['title'] }}
</div>
