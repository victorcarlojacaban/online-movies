  ...
  <div class="wo_section wo_section--video-details rf_no-margin--bottom">
    ...
    @foreach($similarMovies as $similarMovie)
      <?php 
        ...
        $movieTitle= str_replace(' ', '-',strtolower($similarMovie['name']));
        $movieTitle = str_replace("'", "", "$movieTitle");
      ?>

    <a class="wo_video-thumb track_event" data-event-category="More Like" data-event-label="Twilight" data-event-name="Movies" href="/tvshows/show/{{ $movieId }}?&keyword={{ $movieTitle }}&matchtype={{ $parameters['matchtype'] }}&creative={{ $parameters['creative']}}&gclid={{ $parameters['gclid'] }} ">
    <div class="wo_video-thumb__poster" data-content="Watch Online" onclick="window.location.href='/tvshows/show/{{ $movieId }}?&keyword={{ $movieTitle }}&matchtype={{ $parameters['matchtype'] }}&creative={{ $parameters['creative']}}&gclid={{ $parameters['gclid'] }} '"  style="background-image: url({{ $posterImageSimilar  }})"></div>
    <div class="wo_video-thumb__title">
    {{ $similarMovie['name'] }}
    </div>
...
<a class="wo_video-thumb track_event" data-event-category="More Like" data-event-name="Movies" href="/tvshows/show/{{ $movieId }}?&keyword={{ $movieTitle }}&matchtype={{ $parameters['matchtype'] }}&creative={{ $parameters['creative']}}&gclid={{ $parameters['gclid'] }}">
<div class="wo_video-thumb__poster" data-content="Watch Online" onclick="window.location.href='/tvshows/show/{{ $movieId }}?&keyword={{ $movieTitle }}&matchtype={{ $parameters['matchtype'] }}&creative={{ $parameters['creative']}}&gclid={{ $parameters['gclid'] }} '" style="background-image: url({{ $posterImageSimilar  }})"></div>
<div class="wo_video-thumb__title">
{{ $similarMovie['name'] }}
</div>
